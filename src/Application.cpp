...
void Application::Setup() {
	...
	if (bgSurface) {
		backgroundTexture = SDL_CreateTextureFromSurface(Graphics::renderer, bgSurface);
...
void Application::Render() {
	...
	Graphics::DrawTexture(Graphics::Width() / 2.0, Graphics::Height() / 2.0, Graphics::Width(), Graphics::Height(), 0.0f, backgroundTexture);
